 ...
 * This avoids the initialization of the Guice context with all modules.
 */
@Singleton
public class TestGuiceCDIBeanManagerWithInjector {

    private final Injector injector;

    /**
     * Constructs a new TestGuiceCDIBeanManagerWithInjector with the specified injector.
     * 
     * @param injector The Guice injector
     */
    @Inject
    public TestGuiceCDIBeanManagerWithInjector(Injector injector) {
